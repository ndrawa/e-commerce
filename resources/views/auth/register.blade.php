        ...
        <div class="row w-100 h-100">
            <div class="col-lg-6 p-3 py-5 d-flex flex-column">
                <div class="w-100 h-100 px-4 mx-auto d-flex flex-column" style="max-width: 500px">
                    <div class="my-auto">
                        <h1 style="font-weight: 700" class="mb-2 text-primary">Registrasi</h1>
                        <form id="frm" class="row gy-1 gx-2 mt-75 form-validate">
                            ...
                            <div class="col-12">
                                <label class="form-label fw-bolder">Konformasi Password</label>
                                <div class="input-group input-group-merge">
                            ...
                            <div>
                                <a href="{{ url('/login') }}" class="btn btn-secondary w-100 " style="font-size: 14px">
